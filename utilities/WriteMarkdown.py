...
def dict_to_markdown(left_blank: list, md_path: str) -> None:
    ...
    with open(md_file, "w", encoding="utf-8") as mf:
        ...
        mf.write(
            f"## \tThe following list contains fields that were left blank because the referral lacked the necessary information or contained conflicting data. Any non-applicable fields have been omitted from this list. Please review the entire form carefully for any errors or missing details.\n\n"
        )
